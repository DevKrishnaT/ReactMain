...
const App = () => {
  ...
  return (
    ...
    <div className="bg-red-500  py-20 flex justify-center h-full flex-col gap-5 px-5">
      <input type="text" className='border border-white rounded-2xl flex text-white ' placeholder='Here enter'/>
      <button className='bg-white text-red-500 rounded-2xl px-2' onClick={}>click Me to get safe!</button>
    </div>
</div>
